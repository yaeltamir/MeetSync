// Login screen: form submit calls auth API, on success stores user and navigates to meetings
import { fajax, ADDR_AUTH, parseResponseText } from "../api.js";
import { State } from "../state.js";

// Clones the login template and wires the form submit to POST /auth/login.
