// Register screen: validates password match, then calls auth/register and redirects to login
import { fajax, ADDR_AUTH, parseResponseText } from "../api.js";

// Clones the register template, validates password match, and posts to /auth/register.
